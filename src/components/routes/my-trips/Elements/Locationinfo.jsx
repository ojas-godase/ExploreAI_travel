...
function Locationinfo() {
  ...
  return (
    <div ref={locationInfoRef} className="my-1 md:my-5">
      ...
      <div className="carousel opacity-90 mx-auto text-center text-lg font-medium tracking-tight text-primary/80 md:text-lg">
              ...
              <div className="p-1 h-full w-full">
                <Card>
                  <CardContent className="flex max-h-[50vh] rounded-lg overflow-hidden h-full w-full items-center justify-center p-1">
                    <img
                      src={PHOTO_URL.replace("{replace}", imgs.name) || "/images/main_img_placeholder.jpg"}
      ...
      <div className="location-info flex items-center justify-center py-2 gap-2 mt-2">
        <h3 className="opacity-90 bg-foreground/20 px-2 md:px-4 flex items-center justify-center rounded-md text-center text-md font-medium tracking-tight text-primary/80 md:text-lg">
